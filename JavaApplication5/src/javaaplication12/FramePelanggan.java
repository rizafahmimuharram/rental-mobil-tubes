...
public class FramePelanggan extends javax.swing.JFrame {
  ...
  private void resetForm() {
     ...
     private void loadTable() {
        try {
            dbPelanggan db = new dbPelanggan();
            ArrayList<Pelanggan> daftar = db.getPelanggan();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String jenis = jComboBox2.getSelectedItem().toString();

        Pelanggan p = new Pelanggan(id, nama, jenis, Integer.parseInt(tahun));

        dbPelanggan db = new dbPelanggan();
        db.insertPelanggan(p);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        dbPelanggan db = new dbPelanggan();
        ArrayList<Pelanggan> daftar = db.cariPelanggan(key);
